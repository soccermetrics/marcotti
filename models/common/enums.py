...
class WeatherConditionType(DeclEnum):
    ...
    dry_hot = "Hot and Dry"
    humid_hot = "Hot and Humid"
    overcast = "Overcast"
    fog = "Fog/Mist"
    light_rain = "Light Rain"
    rain = "Rain"
    heavy_rain = "Heavy Rain"
    windy_clear = "Clear and Windy"
    windy_mostly_cloudy = "Mostly Cloudy and Windy"
    windy_partly_cloudy = "Partly Cloudy and Windy"
    windy_overcast = "Overcast and Windy"
